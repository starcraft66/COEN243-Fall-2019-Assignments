...
int main(int argc, char *argv[])
{
    ...
    for(int i = 0; i < 2; i++)
    {
        int id, year_hired, tel_area_code, dob_day, dob_month, dob_year;
        std::string first_name, last_name, address, tel_number;
        double salary;
        ...
        std::cin >> dob_day;
        std::cout << "Enter the month of birth (number of the month): ";
        std::cin >> dob_month;
        std::cout << "Enter the year of birth: ";
        std::cin >> dob_year;
        Date dob = Date(dob_day, dob_month, dob_year);
        employees[i] = new Employee(id, first_name, last_name, dob, address, year_hired, salary, tel_area_code, tel_number);
    }
    int i = 0;
    for(auto employee : employees)
    {
        i++;
        int year_hired, tel_area_code, dob_day, dob_month, dob_year;
        std::string first_name, last_name, address, tel_number;
        double salary;
        ...
        std::cout << "Date of birth in pretty format: ";
        employee->GetDateOfBirth().PrintFormattedDate();
        std::cout << "Date of birth in alternate format: ";
        employee->GetDateOfBirth().printDate();
        std::cout << "Month of date of birth: " << employee->GetDateOfBirth().GetMonthInLetters() << std::endl;
        ...
        std::cout << "Enter a new day of birth: ";
        std::cin >> dob_day;
        std::cout << "Enter a new month of birth (number of the month): ";
        std::cin >> dob_month;
        std::cout << "Enter a new year of birth: ";
        std::cin >> dob_year;
        Date dob = Date(dob_day, dob_month, dob_year);
