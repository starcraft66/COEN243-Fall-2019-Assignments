...
class Employee
{
    ...
    std::string first_name_, last_name_, address_, tel_number_;
    double salary_;
    Date dob_;
public:
    Employee();
    Employee(int id_, std::string first_name_, std::string last_name_, Date dob_, std::string address_, int year_hired_, double salary_, int tel_area_code_, std::string tel_number_);
    int GetId();
    void SetId(int id);
