...
Employee::Employee(int id, std::string first_name, std::string last_name, std::string dob, std::string address, int year_hired, double salary, int tel_area_code, std::string tel_number)
{
    this->id_ = id;
...
void Employee::SetDateOfBirth(std::string dob)
{
    this->dob_ = dob;
}
